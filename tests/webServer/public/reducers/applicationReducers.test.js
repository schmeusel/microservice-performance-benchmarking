import {feedbackMessageReducer, settingsReducer} from '../../../../src/webServer/public/reducers/applicationReducers';
...
describe('Test applicationReducers', () => {
    ...
    describe('feedbackMessageReducer', () => {
        ...
        it('should handle FEEDBACK_MESSAGE', () => {
            ...
            expect(result).toEqual(feedbackStub);
        });
    })
});
